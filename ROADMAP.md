...
- [x] Dependency data in snapshots
...
- [ ] Bug fixes: silent file read errors (log + count skipped files)
- [ ] Bug fixes: AnalysisResult builder struct (replace 6-param from_aggregate)
